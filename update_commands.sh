...
# Initialize an empty git repository and configure for sparse checkout for test branch
cd $SPARSE_DIR
git init -q
git remote add origin test $REPO_URL
git config core.sparseCheckout true
