...
cbcs() {
  ...
  main_logic() {
    if [ "$all_info" = true ]; then
      ...
      echo " "
      echo "commands"
      echo "          Description: Display a list of all available custom commands in CBC using bat"
      echo "          Usage: commands"
      echo "          Alias For: 'cbcs | bat'"
      echo " "
      echo "commandsmore"
      echo "          Description: Display a list of all available custom commands in CBC and additional information using bat"
      echo "          Usage: commandsmore"
      echo "          Alias For: 'cbcs -h | bat'"
      echo " "
      echo "comm"
